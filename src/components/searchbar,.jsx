...
export default function SearchBar() {
  ...
  const [search, setSearch] = useState(""); // For tracking the search input
  ...
  return (
    <>
      <div className="flex flex-col px-4 py-3 rounded-md border-2 border-blue-500 overflow-hidden max-w mx-auto">
        {/* Search input */}
      ...
      {search && (
        <div className="searchResults absolute bg-black">
