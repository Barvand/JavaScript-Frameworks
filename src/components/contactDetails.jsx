import { AiFillContacts, AiFillAccountBook, AiFillAlert } from "react-icons/ai";
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-primary">
                ...
                about our products, need assistance with your order, or want to
        ...
        <div className="md:h-auto col-span-12 lg:col-span-6 p-3 grid">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-primary">
                We ship out products from our warehouse after 1 to 3 business
                days.
              </p>
            </div>
          </div>
        ...
        <div className="md:h-auto col-span-12 lg:col-span-6 p-3 grid">
          <div className="flex items-center">
            ...
            <div className="ml-4 text-primary">
              ...
              <p className="">
                We simply have amazing prices, As we are contact with the direct
                supplier of most items. This allows us to keep our marging low
                for our customers.
              </p>
            </div>
          </div>
